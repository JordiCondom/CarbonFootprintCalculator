...
# WASTE
    ...
    # 0 = NOT RECYCLED
    dont_recycle = sum([dataframe['wastePlastic'], dataframe['wasteGlass'], dataframe['wastePaper'], dataframe['wasteAluminium']])
    if dont_recycle[0] >= 1:
...
# ORDER OF THE RECOMENDATIONS based on the CO2 values:
...
#     print(column.upper())
    for element in sasso:
        if element[0] == column:
            recommendation = element[1][0]
#             print('***')
